...
public class Config {
    ...
    public static final String URL_GETAVAILABLEMOBILEDEVICES = BASE_URL + "user/getAvailableSMobileDeviceID";
    ...
    public static final String URL_UPDATESALESDETAILS = BASE_URL + "user/updatesalesdetails";
    ...
    public static final String URL_GETALLDEMOBATCHBYID = BASE_URL + "user/getallDemoBatchById";
    ...
    public static final String URL_GETCOUNTENQUIRIES = BASE_URL + "user/getCountEnquiries";
