...
import in.afckstechnologies.afckssalesapp.adapter.TemplateListAdpter;
...
public class TemplateDisplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_template_display);
        ...
        takeChangeHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getString("user_id", "").equals("")) {
                    finish();
                    Intent intent = new Intent(TemplateDisplayActivity.this, SalesDashBoardActivity.class);
                    startActivity(intent);
