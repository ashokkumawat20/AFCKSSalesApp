...
import in.afckstechnologies.afckssalesapp.MailAPI.GMailSender;
import in.afckstechnologies.afckssalesapp.MailAPI.GMailSender1;
import in.afckstechnologies.afckssalesapp.R;
import in.afckstechnologies.afckssalesapp.models.TemplatesDAO;
import in.afckstechnologies.afckssalesapp.utils.Config;
import in.afckstechnologies.afckssalesapp.utils.FeesListener;
import in.afckstechnologies.afckssalesapp.utils.Utility;
import in.afckstechnologies.afckssalesapp.utils.Utils;
...
// image
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (preferences.getString("sales_user_id", "").equals("RS")) {
            clear.setVisibility(View.VISIBLE);
        }
        if (preferences.getString("sales_user_id", "").equals("AK")) {
            clear.setVisibility(View.VISIBLE);
        }
