...
import in.afckstechnologies.afckssalesapp.adapter.DayPrefrenceListAdpter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        takeChangeHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getString("user_id", "").equals("")) {
                    finish();
                    Intent intent = new Intent(Activity_DayPrefrence_Display.this, SalesDashBoardActivity.class);
                    startActivity(intent);
