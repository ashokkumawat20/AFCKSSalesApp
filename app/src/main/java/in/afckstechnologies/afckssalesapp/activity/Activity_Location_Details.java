...
import in.afckstechnologies.afckssalesapp.adapter.CenterListAdpter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        takeChangeHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getString("user_id", "").equals("")) {
                    finish();
                    Intent intent = new Intent(Activity_Location_Details.this, SalesDashBoardActivity.class);
                    startActivity(intent);
