...
import in.afckstechnologies.afckssalesapp.adapter.AdminStudentListAdpter;
...
import in.afckstechnologies.afckssalesapp.models.BatchesDAO;
import in.afckstechnologies.afckssalesapp.models.LocationDAO;
...
import in.afckstechnologies.afckssalesapp.view.BatchModifyView;
import in.afckstechnologies.afckssalesapp.view.MultipleCommentAddView;

public class DemoStudentsListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_students_list);
        ...
        hideS=(LinearLayout)findViewById(R.id.hideS);
        ...
        sendData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (studentMobileNoArrayList.size() > 0) {
                    Intent intent = new Intent(DemoStudentsListActivity.this, WriteSendSmsActivity.class);
    ...
    public void addTextListener() {
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence query, int start, int before, int count) {
                ...
                if (data != null) {
                    if (data.size() > 0) {
                        for (int i = 0; i < data.size(); i++) {
                            ...
                            String identification3 = data.get(i).getSourse().toLowerCase();
                ...
                mstudentList.setLayoutManager(new LinearLayoutManager(DemoStudentsListActivity.this));
                studentListAdpter = new AdminStudentListAdpter(DemoStudentsListActivity.this, filteredList);
    ...
    private class initBranchSpinner extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = new ProgressDialog(DemoStudentsListActivity.this);
        ...
        protected void onPostExecute(Void args) {
            if (centerResponse.compareTo("") != 0) {
                ...
                ArrayAdapter<LocationDAO> adapter = new ArrayAdapter<LocationDAO>(DemoStudentsListActivity.this, android.R.layout.simple_spinner_dropdown_item, locationlist);
    ...
    private class initBatchSpinner extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void args) {
            if (coursesResponse.compareTo("") != 0) {
                ...
                ArrayAdapter<BatchesDAO> adapter = new ArrayAdapter<BatchesDAO>(DemoStudentsListActivity.this, android.R.layout.simple_spinner_dropdown_item, batcheslist);
    ...
    private class getStudentList extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            Log.i("json", "json" + jsonLeadObj);
            studentListResponse = serviceAccess.SendHttpPost(Config.URL_GETALLDEMOBATCHBYID, jsonLeadObj);
        ...
        protected void onPostExecute(Void args) {
            if (studentListResponse.compareTo("") != 0) {
                studentListAdpter = new AdminStudentListAdpter(DemoStudentsListActivity.this, data);
                mstudentList.setAdapter(studentListAdpter);
                mstudentList.setLayoutManager(new LinearLayoutManager(DemoStudentsListActivity.this));
    ...
    private void setUpItemTouchHelperCourse() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            private void init() {
                ...
                xMark = ContextCompat.getDrawable(DemoStudentsListActivity.this, R.drawable.ic_delete_black_24dp);
                xMark.setColorFilter(Color.BLACK, PorterDuff.Mode.SRC_ATOP);
                xMarkMargin = (int) DemoStudentsListActivity.this.getResources().getDimension(R.dimen.ic_clear_margin);
                initiated = true;
            }
