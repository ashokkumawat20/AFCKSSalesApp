...
import in.afckstechnologies.afckssalesapp.adapter.ContactForEnquiriesListAdpter;
...
public class EnquiriesActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        // TODO Auto-generated method stub
        super.onBackPressed();
        Intent setIntent = new Intent(EnquiriesActivity.this,SalesDashBoardActivity.class);
